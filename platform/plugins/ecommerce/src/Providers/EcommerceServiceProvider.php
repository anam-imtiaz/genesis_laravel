    ...
    public function boot(): void
    {
        ...
        DashboardMenu::beforeRetrieving(function (): void {
            DashboardMenu::make()
                ...
                ->registerItem([
                    'id' => 'cms-plugins-ecommerce-quotes',
                    'priority' => 35,
                    'parent_id' => 'cms-plugins-ecommerce',
                    'name' => 'plugins/ecommerce::quote.menu',
                    'icon' => 'ti ti-file-text',
                    'url' => fn () => route('quotes.index'),
                    'permissions' => ['quotes.index'],
                ])
                ->registerItem([
                    'id' => 'cms-plugins-ecommerce-buy-enquiry',
                    'priority' => 36,
                    'parent_id' => 'cms-plugins-ecommerce-quotes',
                    'name' => 'plugins/ecommerce::quote.buy_enquiry',
                    'icon' => 'ti ti-shopping-cart-plus',
                    'url' => fn () => route('quotes.index'),
                    'permissions' => ['buy-enquiry.index'],
                ])
